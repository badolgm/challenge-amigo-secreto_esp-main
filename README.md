...
Abre el proyecto:
Haz doble clic en index.html o ábrelo desde un servidor local (e.g., Live Server en VS Code) para una experiencia optimizada.
...
Correo: badolfogm@gmail.com (opcional)
